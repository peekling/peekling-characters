...
| ![Byte](packages/pack-byte/thumbnail.png) | [Byte](packages/pack-byte) | A futuristic cyber cat that runs, chases, scans, and reacts through a cyan visor and animated tech effects. | `0.1.2` | [`@peekling/pack-byte`](https://www.npmjs.com/package/@peekling/pack-byte/v/0.1.2) |
...
| ![Nib](packages/pack-nib/thumbnail.png) | [Nib](packages/pack-nib) | A tiny futuristic racing car with expressive windshield eyes, rolling wheels, telemetry, drifting, and boost reactions. | `1.0.0` | [`@peekling/pack-nib`](https://www.npmjs.com/package/@peekling/pack-nib/v/1.0.0) |
